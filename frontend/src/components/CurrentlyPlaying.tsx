...
function CurrentlyPlaying() {
  ...
  return (
    <div style={pageStyle}>
      ...
      <div style={{ 
        background: 'linear-gradient(135deg, rgba(29, 185, 84, 0.15) 0%, rgba(0, 0, 0, 0.3) 100%)',
        padding: '40px', 
        borderRadius: '24px',
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{
              backgroundColor: currentTrack.isPlaying ? '#1DB954' : 'rgba(255, 255, 255, 0.9)',
              ...
              <span style={{ fontSize: '1.1rem' }}>{currentTrack.isPlaying ? '▶' : '⏸'}</span>
            ...
            {currentTrack.duration_ms && (
              <div style={{ marginTop: '10px' }}>
                ...
                <div style={{
                  ...
                  <span>{currentTrack.progress_ms ? formatDuration(currentTrack.progress_ms) : '0:00'}</span>
